  ...
  <div class="container">
    <div class="card">
      ...
      <div id="forgotGuide" style="display: none; margin-top: 14px; padding: 12px 14px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; font-size: 12px; line-height: 1.6; color: var(--text-secondary); text-align: left;">
        ...
        <div style="margin-top: 4px;">2. <strong>服务器救急指令</strong>：在宿主电脑终端执行 <code style="background: rgba(0,0,0,0.4); padding: 2px 6px; border-radius: 4px; color: #34d399; font-family: monospace;">touch ~/.dsh/dsh-bridge-gateway/reset-auth</code> 即可瞬间恢复初始免密状态。</div>
      </div>

      <div class="footer">
        由 <a href="https://github.com/lament-z/dsh-bridge-gateway" target="_blank">dsh-bridge</a> 安全网关守护
      </div>
    </div>
  </div>
